...
**Hello React Front-End** is an app where I received and displayed greetings from an API called from [this back-end project](https://github.com/asnganje/hello-rails-back-end.git)
...
```
- To clone the repository run this command - "https://github.com/asnganje/hello-react-front-end.git"
